...
docker-compose run --rm tests freqtrade test-pairlist -c /testing/configs/pairlists-$TRADING_MODE.json -c /testing/configs/pairlist-static-$EXCHANGE-$TRADING_MODE-usdt.json -c /testing/configs/exampleconfig.json -1 --exchange $EXCHANGE -c /testing/configs/blacklist-$TRADING_MODE.json|sed -e 's+/+_+g'>>PAIRS_FOR_DOWNLOAD.txt
