...
class NostalgiaForInfinityX2(IStrategy):
    ...
    stop_thresholds_normal = [-0.2, -0.2, -0.025, -0.025, 720, 720, 0.016, 0.016, 20.0, 20.0, True, True, True, True]
    stop_thresholds_pump = [-0.2, -0.2, -0.025, -0.025, 720, 720, 0.016, 0.016, 20.0, 20.0, True, True, True, True]
    stop_thresholds_quick = [-0.2, -0.2, -0.025, -0.025, 720, 720, 0.016, 0.016, 20.0, 20.0, True, True, True, True]
    stop_thresholds_rebuy = [-0.2, -0.2, -0.025, -0.025, 720, 720, 0.016, 0.016, 20.0, 20.0, True, True, True, True]
    stop_thresholds_long = [-0.2, -0.2, -0.025, -0.025, 720, 720, 0.016, 0.016, 20.0, 20.0, True, True, True, True]
