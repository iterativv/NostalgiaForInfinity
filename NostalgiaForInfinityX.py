...
class NostalgiaForInfinityX(IStrategy):
    ...
    def sell_pivot(self, current_profit: float, max_profit:float, max_loss:float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        ...
        if (last_candle['close'] > (last_candle['res3_1d'] * 1.8)):
            if (0.02 > current_profit >= 0.01):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 44.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_1_1'
            elif (0.03 > current_profit >= 0.02):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 45.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_2_1'
            elif (0.04 > current_profit >= 0.03):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 46.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_3_1'
            elif (0.05 > current_profit >= 0.04):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 47.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_4_1'
            elif (0.06 > current_profit >= 0.05):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 48.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                ...
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 43.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_10_1'
            elif (0.2 > current_profit >= 0.12):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 42.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
                    return True, 'sell_profit_pv_4_11_1'
            elif (current_profit >= 0.2):
                if (last_candle['r_480'] > -35.0) and (last_candle['rsi_14'] < 41.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -35.0):
