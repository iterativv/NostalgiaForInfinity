    ...
    def sell_pivot(self, current_profit: float, max_profit:float, max_loss:float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        ...
        if (last_candle['close'] > (last_candle['res3_1d'] * 1.8)):
            if (0.02 > current_profit >= 0.01):
                ...
                if (last_candle['r_480'] > -30.0) and (last_candle['rsi_14'] < 40.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -30.0):
                    return True, 'sell_profit_pv_4_9_1'
            elif (0.12 > current_profit >= 0.1):
                if (last_candle['r_480'] > -30.0) and (last_candle['rsi_14'] < 39.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -30.0):
                    return True, 'sell_profit_pv_4_10_1'
            elif (0.2 > current_profit >= 0.12):
                if (last_candle['r_480'] > -30.0) and (last_candle['rsi_14'] < 38.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -30.0):
                    return True, 'sell_profit_pv_4_11_1'
            elif (current_profit >= 0.2):
                if (last_candle['r_480'] > -30.0) and (last_candle['rsi_14'] < 37.0) and (last_candle['rsi_14_1h'] > 60.0) and (last_candle['r_480_1h'] > -30.0):
