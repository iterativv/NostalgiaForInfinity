...
The image footer reads "Generated by" plus the page URL as a provenance watermark;
it can be disabled with the Watermark checkbox. Pages opened from disk show a neutral
